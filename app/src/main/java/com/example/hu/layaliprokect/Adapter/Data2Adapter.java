...
public class Data2Adapter extends BaseAdapter {
    ...
    public Data2Adapter(Context context, List<TaskEntity> list, DataFragment dataFragment) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.lltitleName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dataFragment.onItemClick(list.get(i));
            }
        });
        //长按点击事件
        viewHolder.lltitleName.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                dataFragment.onItemLongClick(taskEntity);
